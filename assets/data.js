export const introData = [
    ...
    },
    {
        ...
        name: "Description",
        header: "Travel Crew",
        description: "TC is a mobile app for friends to share and organize travel plans and even create full itineraries together.",
        description2: "TC allows users to follow friends,view upcoming trips, vote on lodging and activities and even split expenses!",
        image: "friends2.png"
    },
]
export const features = [
    {
        ...
        cards: [{
            id: 100,
            header: "LODGING",
            description: "Whether its VRBO, Airbnb or a friends couch, list all your lodging options for your crew to see!",
            image: "22.png"
        },
        {
            id: 101,
            header: "ACTIVITIES",
            description: "List and vote on the best activities. There's always something to do for everyone!",
            image: "23.png"
        },
        {
            id: 102,
            header: "SPLIT",
            description: "Simplify your expense with our split feature. See who paid for what with the click of a button!",
            image: "24.png"
        }]
    }
]
...
export const testomonials = [
    {
        ...
        cards: [{
            id: 107,
            name: "JJ",
            description: "A journey well shared is a journey well enjoyed. Perfect for planning group trips! I truly enjoy this app and will continue to utilize it to plan out my next adventures with my travel crew!",
        },
        {
            id: 108,
            name: "Chris",
            description: "Great app! Solves all my travel planning needs plus it's so easy to share my plans with friends.",
        },
        {
            id: 109,
            name: "Nancy",
            description: "Can’t imagine planning a trip with my friends without inviting them to use Travel Crew in the future!",
        },
        {
            id: 110,
            name: "M. Wall",
            description: "Love using this app to share my trips with family and friends, especially the friends that I typically travel with. I can easily shared my trips with my “Travel Crew” and collaborate on all aspects of the trip from places to stay all the way to sight seeing.",
        }]
    }
]
...
export const terms = 
    {
        ...
        description: [
            "1. Your Relationship With Us", "Welcome to Travel Crew (the 'Application'), which is provided by Kai Technologies Corp. in the United States (collectively such entities will be referred to as “Travel Crew”, “we” or “us”).",
